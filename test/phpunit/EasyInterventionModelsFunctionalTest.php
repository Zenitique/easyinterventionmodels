...
/**
 * \file    test/phpunit/EasyInterventionModelsFunctionalTest.php
...
/**
 * Class EasyInterventionModelsFunctionalTest
 *
 ...
 *
 * @package Testeasyinterventionmodels
 */
class EasyInterventionModelsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEasyInterventionModels')->click();
		} else {
			// Disable the module
			$this->byHref('modEasyInterventionModels')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/easyinterventionmodels/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('easyinterventionmodels/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/easyinterventionmodels/admin/about.php');
		$this->authenticate();
		return $this->assertContains('easyinterventionmodels/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('easyinterventionmodelswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEasyInterventionModels_EasyInterventionModelsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEasyInterventionModels_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
